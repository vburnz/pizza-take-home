...
describe('Dispatcher Class', function() {
    ...
    it('should properly dispatch two pizza deliverers', function(){ 
        ...
        dispatcher.dispatchCrew(); 
        expect(summary.getTotalHouses()).to.equal(11); 
    })
    it('should properly dispatch two pizza deliverers', function(){ 
        let crewArr = [new PizzaDeliverer(), new PizzaDeliverer()]
        dispatcher = new Dispatcher(directionStrThree, crewArr); 
        ...
        dispatcher.dispatchCrew(); 
        expect(summary.getTotalHouses()).to.equal(2639)
    })
    it('should properly dispatch three pizza deliverers', function(){ 
        let crewArr = [new PizzaDeliverer(), new PizzaDeliverer(), new PizzaDeliverer()]
        dispatcher = new Dispatcher('<>v<>v<>v<>v<>v', crewArr); 
        let summary = new Summary(crewArr); 

        dispatcher.dispatchCrew(); 
        expect(summary.getTotalHouses()).to.equal(16); 
    })
    it('should properly dispatch four pizza deliverers', function(){ 
        let crewArr = [new PizzaDeliverer(), new PizzaDeliverer(), new PizzaDeliverer(), new PizzaDeliverer()]
        dispatcher = new Dispatcher('<>^v<>^v<>^v<>^v<>^v', crewArr); 
        let summary = new Summary(crewArr); 

        dispatcher.dispatchCrew(); 
        expect(summary.getTotalHouses()).to.equal(21); 
    })
    it('should properly dispatch five pizza deliverers', function(){ 
        let crewArr = [new PizzaDeliverer(), new PizzaDeliverer(), new PizzaDeliverer(), new PizzaDeliverer(), new PizzaDeliverer()]
        dispatcher = new Dispatcher('<>^v<>^v<>^v<>^v<>^v', crewArr); 
        let summary = new Summary(crewArr); 

        dispatcher.dispatchCrew(); 
        expect(summary.getTotalHouses()).to.equal(7); 
    })
}); 